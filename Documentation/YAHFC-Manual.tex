...
${\texttt{event\_generator}}$ & ${\texttt{Answer}}_1$~~~${\texttt{Answer}}_2$ & ${\texttt{Answer}}_1$ = ${\texttt{y/t/1}}$: Prints events only, no library files. \\
   ...
   &    & ${\texttt{Answer}}_2$(optional) = ${\texttt{n/f/0}}$: Event files are labeled by the energy in the calculation; incident projectile energy or population energy ({\bf Default}). \\\hline
